...
class ItemVegorNonVeg(BaseModel):
    veg: Optional[bool] = Field(default=None, description="veg or non-veg in true or false")
    non_veg: Optional[bool] = Field(default=None, description="veg or non-veg in true or false")


class AddIndexFromMongoDb(BaseModel):
