...
internal_keys = {
    "openai":envConfig.openai_secret_key,
    "azure_openai":envConfig.azure_openai_secret_key,
    "anthropic":envConfig.anthropic_secret_key,
    "google":envConfig.google_secret_key,
    "xyzcloud":envConfig.xyzcloud_secret_key,
    "partnerai":envConfig.partnerai_secret_key
}
